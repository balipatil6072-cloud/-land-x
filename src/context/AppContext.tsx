        ...
        warningTimeline: [
          {
            ...
            description: `KSHETRA AI engine completed risk assessment. Score: ${risk.riskScorePercent}% (${risk.riskCategory}).`,
